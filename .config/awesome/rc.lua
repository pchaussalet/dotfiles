...
local modkey       = "Mod4"
local altkey       = "Mod1"
local terminal     = "st" or "stterm" or "xterm"
...
globalkeys = awful.util.table.join(
    -- Lock the screen
    awful.key({ modkey, altkey }, "l", function() os.execute("xscreensaver-command -lock") end),
    -- Take a screenshot
...
--              {description = "show main menu", group = "awesome"}),
    ...
    -- User programs
    awful.key({ modkey }, "w", function () awful.spawn("webstorm") end),
